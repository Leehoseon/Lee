...
<body>
  ...
  <ul>
    <c:forEach items="${list}" var="todo">
      <li><span><a class='link' href='${todo.tno}'>${todo.tno}  </a></span><span>${todo.title} ${todo.replycnt} </span> 
      <%-- <button class='delBtn' data-tno='${todo.tno}'>DEL</button> </li>	 --%>
    </c:forEach>  
  </ul>
  <div>
  <form action="/todo2/register">
 ...
 <form id='form1' action="/todo2/view" method='get'>
